...
### Base URL
```
https://money2025-tunderback11.krkzfx.easypanel.host/
```
...
### Exemplo de Registro
```javascript
const response = await fetch('https://money2025-tunderback11.krkzfx.easypanel.host/auth/register', {
  method: 'POST',
...
### Exemplo de Login
```javascript
const response = await fetch('https://money2025-tunderback11.krkzfx.easypanel.host/auth/login', {
  method: 'POST',
  headers: { 'Content-Type': 'application/json' },
  body: JSON.stringify({
    phone: '+5511999999999',
...
# Login
curl -X POST https://money2025-tunderback11.krkzfx.easypanel.host/auth/login \
  -H "Content-Type: application/json" \
  -d '{"phone": "11999888777", "password": "senha123"}'

# Gerar PIX (com token)
curl -X POST https://money2025-tunderback11.krkzfx.easypanel.host/pix/generate \
  -H "Content-Type: application/json" \
